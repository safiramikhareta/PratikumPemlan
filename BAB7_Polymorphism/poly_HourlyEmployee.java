...
public class poly_HourlyEmployee extends poly_Employee{
    private double wage; //upah per jam
    private double hours; //jumlah jam tiap minggu

    public poly_HourlyEmployee(String name, String noKTP, double hourlyWage, double hoursWorked, int tanggal, int bulan, int tahun){
